...
class ui(QMainWindow):
	...
	def setupUi( self, x, y ):
		...
		self.pingLabel.setGeometry( QtCore.QRect( 15, 540, 300, 17 ))
		...
		self.callsForTodayLabel = QtWidgets.QLabel( self.weatherGroupBox )
		self.callsForTodayLabel.setGeometry( QtCore.QRect( 150, 140, 21, 17 ))
		self.callsForTodayLabel.setObjectName( "callsForTodayLabel" )
	...
	def retranslateUi(self, MainWindow):
		...
		self.callsForTodayLabel.setText( _translate( "MainWindow", "50" ))

		#self.fontComboBox.setItemText(0, _translate("MainWindow", "aaaaaaaaTimes New Roman"))